     ...
     bottomNavigationBar: BottomNavigationBar(
      onTap: (index){
       ...
       BottomNavigationBarItem(icon:SvgPicture.asset(Assets.icons.home,
         colorFilter:currentIndex==0? ColorFilter.mode(AppColors.primaryColor, BlendMode.srcIn):null ,) , label: ""),
       BottomNavigationBarItem(icon: SvgPicture.asset(Assets.icons.bookMark
       , colorFilter:currentIndex==1?ColorFilter.mode(AppColors.primaryColor, BlendMode.srcIn):null) , label: ""),
       BottomNavigationBarItem(icon: SvgPicture.asset(Assets.icons.category,
           colorFilter:currentIndex==2?ColorFilter.mode(AppColors.primaryColor, BlendMode.srcIn):null) , label: ""),
       BottomNavigationBarItem(icon: SvgPicture.asset(Assets.icons.profile,
           colorFilter:currentIndex==3?ColorFilter.mode(AppColors.primaryColor, BlendMode.srcIn):null) , label: ""),
     ]),
